...
public class Order {
    ...
    public BigDecimal getMaterialCost() {return this.materialCost;}
    ...
    public void print() {
        String orderStr = Integer.toString(this.getOrderNumber()) + ", " +
                this.getCustomerName() + ", " +
                this.getState() + ", " +
                this.getTaxRate().toString() + ", " +
                this.getProductType() + ", " +
                this.getArea().toString() + ", " +
                this.getCostPerSquareFoot().toString() + ", " +
                this.getLaborCostPerSquareFoot().toString() + ", " +
                this.getMaterialCost().toString() + ", " +
                this.getLaborCost().toString() + ", " +
                this.getTax().toString() + ", " +
